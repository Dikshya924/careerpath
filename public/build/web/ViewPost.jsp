...
<html>
    ...
    <body>
        ...
        <tr>
            ...
            <td><a href="viewApplicant.jsp?id=<%=pp.getPid()%>" class="btn btn-outline-primary">Applicants</a>
            <td><a href="updatePost?id=<%=pp.getPid()%>" class="btn btn-outline-primary btnEdit" data-toggle="modal" >Update</a>
             <td><a href="DeletePost?id=<%=pp.getPid()%>" class="btn btn-outline-primary">Delete</a>
            </td>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="updatePost" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputSno" name="id">
