...
<html>
    ...
    <body>
        ...
        <div class="row mt-5 mb-5 ml-5">
            ...
            <div class="col-md-4">
                <div class="card text-center" style="border: none;max-width: 400px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                    <img class="card-img-top" src="images/sony.jpg" >
                    <div class="card-body">
                        <h3 class="card-title">Sony Tuladhar</h3>
                        <p>Project Manager</p> 
                    </div>
                </div>
            </div>
             <div class="col-md-4">
                <div class="card text-center" style="border: none;max-width: 400px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                    <img class="card-img-top" src="images/sunita.jpg" >
                    <div class="card-body">
                        <h3 class="card-title">Sunita Shrestha</h3>
